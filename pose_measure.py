...
pose_measure.py
----------------
MediaPipe Pose ব্যবহার করে শরীরের ল্যান্ডমার্ক ডিটেক্ট করা এবং
সেখান থেকে শার্ট/টি-শার্টের মাপ (কাঁধ, দৈর্ঘ্য, হাতা, বুকের ঘের) বের করা হয়।
...
class PoseMeasurer:
    ...
    def draw(self, img_bgr: np.ndarray) -> np.ndarray:
    ...
    def compute_measurements(self, frames_list):
        ...
        # --- ক্যালিব্রেশন: pixel height বনাম আসল height (cm) ---
        ...
        chest_depth_cm = chest_width_cm * 0.55  # সাধারণ torso অনুপাত (সামনে-পিছন গভীরতা)
        ...
        if hip_l is not None and hip_r is not None:
            ...
            length_cm = self._dist(shoulder_mid, hip_mid) * scale * 1.15  # হিপের সামান্য নিচ পর্যন্ত ধরে adjustment
